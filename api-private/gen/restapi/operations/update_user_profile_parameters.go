...
// UpdateUserProfileParams contains all the bound params for the update user profile operation
...
//
// To ensure default values, the struct must have been initialized with NewUpdateUserProfileParams() beforehand.
func (o *UpdateUserProfileParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
